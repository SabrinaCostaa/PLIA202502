🧩 Racha-Cuca “Happy Hour” — Solução em Prolog

Este projeto implementa, em Prolog, a resolução do desafio lógico
🎯 “Happy Hour” disponível em:
🔗 https://rachacuca.com.br/logica/problemas/happy-hour/


🧠 Descrição do Problema

Cinco amigos participam de um happy hour.
Cada um deles tem uma idade, uma cor de gravata, uma cerveja preferida, um setor de trabalho e um esporte favorito diferentes.
O objetivo é descobrir a ordem em que estão sentados e as combinações corretas de cada característica.
...
Quem gosta de Natação está exatamente à direita de quem está bebendo a cerveja Belga.
...
Inspirado no desafio Happy Hour do site Racha Cuca.